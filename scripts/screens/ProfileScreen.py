...
class ProfileScreen(Screens):
    ...
    def build_profile(self):
        ...
        if is_sc_instructor:
            self.the_cat.thought = "Hello. I am here to guide the dead cats of " + game.clan.name + "Clan into the Domain of Light."
        if is_df_instructor:
            self.the_cat.thought = "Hey, kids! I'm here to drag the dead cats of " + game.clan.name + "Clan into the Grimm pools!"
